function rFSDs = fEfourier_edit_oct26(outline, iNoOfHarmonicsAnalyse, bNormaliseSizeState, bNormaliseOrientationState)
...
% figure(101)
% subplot(2,2,1);plot(rDeltaT,'*');title('rDeltaT');
% subplot(2,2,2);plot(rDeltaX,'*');title('rDeltaX');
% subplot(2,2,3);plot(rDeltaY,'*');title('rDeltaY');
% subplot(2,2,4);plot(rDeltaX,rDeltaY,'*');title('XY');
